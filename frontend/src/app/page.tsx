  ...
  return (
    <Providers>
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse at center, #060810cc 0%, #060810f0 100%)", zIndex: 1 }}
        aria-hidden="true"
      />
      {/* Green atmospheric glow */}
      <div
        className="fixed inset-x-0 top-0 h-64 pointer-events-none"
        style={{ background: "radial-gradient(ellipse at 50% -20%, #39ff1408 0%, transparent 70%)", zIndex: 1 }}
        aria-hidden="true"
      />

      <div className="relative z-10 min-h-screen flex flex-col">
        <Header />
        <main className="flex-1 px-3 sm:px-6 py-3 sm:py-5 w-full max-w-[1380px] mx-auto">
          <StoryScroll />
        </main>
        <footer className="text-center py-3 border-t border-siggy-green/10">
          <p className="text-mist/25 text-[10px] sm:text-xs font-body tracking-wider">
